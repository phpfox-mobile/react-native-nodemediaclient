...
public class NodeCameraViewManager extends ViewGroupManager<RCTNodeCameraView> {
    ...
    private static final int COMMAND_ZOOM_ID = 6;
    private static final String COMMAND_ZOOM_NAME = "zoom";
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.of(COMMAND_STARTPREV_NAME, COMMAND_STARTPREV_ID, COMMAND_STOPPREV_NAME, COMMAND_STOPPREV_ID,
                ...
                COMMAND_SWITCH_CAM_ID, COMMAND_SWITCH_FLASH_NAME, COMMAND_SWITCH_FLASH_ID, COMMAND_ZOOM_NAME, COMMAND_ZOOM_ID);
    }
